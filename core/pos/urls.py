...
from core.pos.views.scm.productStart.views import *
...
from core.pos.views.scm.orders.views import *
...
urlpatterns = [
    ...
    # category1
    path('scm/productStart/', ProductStartListView.as_view(), name='productStart_list'),
    path('scm/productStart/add/', ProductStartCreateView.as_view(), name='productStart_create'),
    path('scm/productStart/update/<int:pk>/', ProductStartUpdateView.as_view(), name='productStart_update'),
    path('scm/productStart/delete/<int:pk>/', ProductStartDeleteView.as_view(), name='productStart_delete'),
    # product
    ...
    # orders
    path('scm/order/pending/', order_pending_list, name='order_pending'),
    path('scm/order/accepted/', order_accepted_list, name='order_accepted'),
    path('scm/order/rejected/', order_rejected_list, name='order_rejected'),
    path('scm/order/update/<int:id>/', update_order, name='update_order'),
    # purchase
