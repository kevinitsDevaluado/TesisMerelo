    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='category/%Y/%m/%d', verbose_name='Imagen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cod_barra', models.CharField(blank=True, max_length=150, null=True, verbose_name='Código de Barra')),
                ...
                ('iva', models.CharField(choices=[('Si', 'Si'), ('No', 'No')], default='Si', max_length=10, verbose_name='Cobranza Iva')),
                ('activo', models.BooleanField(default=True, verbose_name='Activo')),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='productmes/%Y/%m/%d', verbose_name='Imagen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disponibilidad', models.CharField(blank=True, default='0', max_length=2, null=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='sale/%Y/%m/%d', verbose_name='Sale')),
                ('payment_condition', models.CharField(choices=[('contado', 'Contado'), ('credito', 'Credito')], default='contado', max_length=50)),
