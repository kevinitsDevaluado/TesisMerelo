...
class ProductStart(models.Model):
    #product = models.ForeignKey(Product, on_delete=models.PROTECT)
    image = models.ImageField(upload_to='productmes/%Y/%m/%d', verbose_name='Imagen', null=True, blank=True)
    descripcion = models.CharField(max_length=1000, unique=True, verbose_name='Descripción de la promoción')
    activo = models.BooleanField(default=True, verbose_name='Activo')
    ...
    class Meta:
        verbose_name = 'Producto Estrella'
        verbose_name_plural = 'Productos Estrellas'
        permissions = ()
        ordering = ['-id']
...
class SaleDetail(models.Model):
    ...
    # @property
    # def get_total(self):
    #     saleitems = self.product_set.all()
    #     total = sum([item.get_price_promotion for item in saleitems])
    #     return total
